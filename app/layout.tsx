...
export const metadata: Metadata = {
  ...
  description: 'A modern restaurant experience with seasonal menus, multiple locations, and easy reservations.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="min-h-screen flex flex-col bg-brand-50">
        <Header />
